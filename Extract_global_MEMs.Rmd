...
bricktotime <-function(br=1,all_bricks,lyr=1,month=1){
  ...
  for(elyr in lyr:lyrend){
      bricksum[,elyr]<-cellStats(all_bricks[[br]][[lyr]][[month:monthend]]*area(all_bricks[[4]][[1]][[month]])*1e6,sum)
  }
  return(bricksum)
}
...
#all_bricksums<-pbsapply(1:length(non_empties),bricktotime,all_bricks=non_empties,cl=26)
