...
# same as provided by DT but different from approach above and CN results - see inside function but this could also be due to the fact that these are months instead of years.  
